...
const ShipmentRequest = () => {
    ...
    {field: 'orderId', headerName: 'RequestID', filter: true, flex: 1.5, filter: true,floatingFilter: true},
    {field: 'approvedby', headerName: 'From(Supplier)', filter: true, flex: 1.5, filter: true,floatingFilter: true},
     ...
     {field:'value', headerName: 'Quantity',  flex: 1.5, filter: true,floatingFilter: true},
    //  {
